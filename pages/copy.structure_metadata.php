...
if ($func == '') {
    ...
    $formElements = [];
    $n = [];
    $n['field'] = '<a class="btn btn-apply sprog-copy-button-start" href="' . rex_url::backendPage('sprog.copy.structure_metadata_popup') . '">' . $this->i18n('sprog_copy_button_start') . '</a>';
    $formElements[] = $n;
